...
const Apod = () => {
    ...
    return (
        ...
        <div className="mx-5">
            <h1 className="text-2xl lg:text-4xl font-bold text-center  my-10">Astronomy Picture of the Day</h1>

            <div className="flex justify-center ">
                <div className=" flex flex-col justify-center items-center lg:w-[60%] gap-5 shadow-2xl rounded-lg mb-28 py-10">

                    <h1 className="font-bold text-2xl lg:text-4xl">{apod?.title}</h1>
